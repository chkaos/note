...
// genny is a code-generation generics solution. It allows you write normal buildable and testable Go code which,
//  when processed by the genny gen tool, will replace the generics with specific types.
